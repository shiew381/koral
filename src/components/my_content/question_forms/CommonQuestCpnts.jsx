...
export function WordOrPhraseInput({ isMultipart, partIndex }) {
  return (
    <Field
      name={
        isMultipart
          ? `parts.${partIndex}.correctWordOrPhrase`
          : "correctWordOrPhrase"
      }
...
export function PercentToleranceField({ isMultipart, partIndex, values }) {
  return (
    <Field
      name={
        isMultipart ? `parts.${partIndex}.percentTolerance` : "percentTolerance"
      }
...
export function NumberField({ isMultipart, partIndex }) {
  return (
    <Field
      name={isMultipart ? `parts.${partIndex}.correctNumber` : "correctNumber"}
      as={NumberInputField}
    />
  );
}

export function UnitField({ isMultipart, partIndex }) {
  return (
    <Field
      name={isMultipart ? `parts.${partIndex}.correctUnit` : "correctUnit"}
      as={UnitInputField}
    />
  );
}

export function WordOrPhraseScoringOptions({ values, isMultipart, partIndex }) {
  return (
    <>
      <Box className="flex-align-center">
        <Field
          name={
            isMultipart
              ? `parts.${partIndex}.acceptAlternateSpacing`
              : "acceptAlternateSpacing"
          }
          color="primary"
          checked={values.acceptAlternateSpacing}
          as={Checkbox}
        />
      ...
      <Box className="flex-align-center">
        <Field
          name={
            isMultipart
              ? `parts.${partIndex}.acceptAlternateCapitalization`
              : "acceptAlternateCapitalization"
          }
          as={Checkbox}
          color="primary"
          checked={values.acceptAlternateCapitalization}
        />
