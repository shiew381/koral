...
import { editQuestionSetTitle } from "../../app/firestoreClient.js";

export default function EditQuestionSetTitle({ questionSetID, title, userID }) {
          ...
          <Box className="modal-form-v1 modal-common-styling">
            <Formik
              ...
              onSubmit={async (values, { setSubmitting, resetForm }) => {
                ...
                try {
                  editQuestionSetTitle(values, userID, questionSetID);
                } catch (error) {
